        ...
        >
          <div className="bg-[#0a192f] px-8 py-10 text-center">
            <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center mx-auto mb-4">
              <span className="text-[#0a192f] text-2xl font-bold">AT</span>
            </div>
            <h1 className="text-2xl font-bold text-white">Aura Track</h1>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 hidden sm:block">Aura Track Admin Portal</p>
              </div>
            </div>
