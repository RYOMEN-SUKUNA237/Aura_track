...
export const serviceDetails: ServiceDetail[] = [
  // ─── AIR FREIGHT ─────────────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'At Aura Track, we leverage strategic partnerships with major airlines and cargo carriers across 500+ airports worldwide, delivering seamless air cargo solutions tailored to your unique requirements. Our advanced tracking infrastructure provides real-time visibility from takeoff to touchdown, giving you complete peace of mind throughout the journey.',
    ...
    serviceTypesIntro: 'Aura Track offers a comprehensive range of air freight solutions designed to meet diverse shipping requirements:',
    serviceTypes: [
    ...
    processTitle: 'How Air Freight Works with Aura Track',
  ...
  // ─── OCEAN FREIGHT ───────────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'Aura Track provides comprehensive ocean freight services — from full container loads (FCL) and less-than-container loads (LCL) to specialized reefer and open-top containers. We maintain strategic partnerships with leading ocean carriers to secure competitive rates and guaranteed space across all major trade lanes.',
    ...
    serviceTypesIntro: 'Aura Track delivers end-to-end ocean freight solutions tailored to your specific trade requirements:',
    serviceTypes: [
    ...
    processTitle: 'How Ocean Freight Works with Aura Track',
  ...
  // ─── LAND TRANSPORT ──────────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'Aura Track operates an extensive ground transportation network featuring GPS-tracked fleets, experienced drivers, and strategically positioned hubs. Our road and rail solutions seamlessly integrate with air and ocean freight to deliver true door-to-door coverage anywhere on the map.',
    ...
    serviceTypesIntro: 'Aura Track provides a full spectrum of ground freight solutions for every requirement:',
    serviceTypes: [
    ...
    processTitle: 'How Land Transport Works with Aura Track',
  ...
  // ─── EXPRESS COURIER ─────────────────────────────────────────────
  {
    ...
    serviceTypesIntro: 'Aura Track offers tiered express services to match your urgency and budget:',
    serviceTypes: [
  ...
  // ─── WAREHOUSING & DISTRIBUTION ──────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'Aura Track operates a network of strategically located warehousing facilities across key logistics hubs worldwide. Our facilities are equipped with advanced WMS technology, climate-controlled zones, high-security systems, and scalable layouts designed to grow with your business.',
    ...
    whyChooseIntro: 'Outsourcing warehousing to Aura Track unlocks significant operational and financial advantages:',
    benefits: [
    ...
    serviceTypesIntro: 'Aura Track provides comprehensive warehousing and distribution solutions:',
    serviceTypes: [
    ...
    processTitle: 'How Warehousing Works with Aura Track',
    ...
    ctaDescription: 'Let Aura Track design a warehousing and distribution strategy that reduces costs, improves speed, and scales with your business.',
    galleryImages: [
  ...
  // ─── SPECIALIZED CARGO ───────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'Aura Track\'s specialized cargo division brings together project logistics engineers, certified dangerous goods handlers, fine art specialists, and pharmaceutical logistics experts. We design bespoke transport solutions that address the unique challenges each specialized shipment presents.',
    ...
    serviceTypesIntro: 'Aura Track offers expert handling across a wide range of specialized cargo categories:',
    serviceTypes: [
  ...
  // ─── ANIMAL DELIVERY ──────────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'At Aura Track, our Animal Transport Division is staffed by certified animal handlers, veterinary consultants, and logistics specialists who understand that your animals are not cargo — they are family. We design bespoke transport plans that prioritize animal welfare above all else, ensuring comfortable temperatures, proper ventilation, adequate hydration, and minimal stress from origin to destination.',
      'Whether you\'re relocating internationally with your dog, shipping breeding livestock across state lines, transporting exotic reptiles for a zoological program, or moving laboratory animals under strict protocol, Aura Track provides end-to-end solutions that comply with IATA Live Animals Regulations (LAR), USDA-APHIS requirements, CITES conventions, and all local animal welfare laws.',
    ],
    whyChooseTitle: 'Why Choose Professional Animal Transport?',
    whyChooseIntro: 'Transporting live animals requires expertise, certified equipment, and unwavering commitment to animal welfare. Here\'s why Aura Track stands apart:',
    benefits: [
    ...
    serviceTypesIntro: 'Aura Track offers comprehensive animal transport solutions tailored to every species, size, and destination:',
    serviceTypes: [
    ...
    processTitle: 'How Animal Transport Works with Aura Track',
