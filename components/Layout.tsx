      ...
      <div className="hidden lg:block bg-[#0a192f] text-gray-300 text-xs py-2">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-1.5"><Phone className="w-3 h-3" /> +1 (800) 555-AURA</span>
            <span className="flex items-center gap-1.5"><Mail className="w-3 h-3" /> info@auratrack.com</span>
      ...
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">AURA TRACK</span>
              </div>
        ...
        <div className="border-t border-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
            <p>© {new Date().getFullYear()} Aura Track Logistics. All rights reserved.</p>
